...
!(function (n, t) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = t() : typeof define === 'function' && define.amd ? define(t) : (n = n || self).getSecuritySign = t()
}(this, function () {
  'use strict'
  var n = (function () {
  ...
  n.__sign_hash_20200305 = function (n) {
    ...
    function t (n) {
      return (function (n) {
        ...
        n[t >> 5] |= 128 << t % 32,
        n[14 + (t + 64 >>> 9 << 4)] = t
        var o; var e; var u; var p; var i; var r = 1732584193; var f = -271733879; var h = -1732584194; var c = 271733878
    ...
    return (function (n) {
      var t; var o; var e = '0123456789abcdef'; var u = ''
  ...
  (function r (f, h, c, l, g) {
    ...
    function () {
      var n = g[g.length - 2]
      var t = Object.getOwnPropertyDescriptor(n[0], n[1]) || {
        configurable: !0,
        enumerable: !0
      }
      t.get = g[g.length - 1],
    ...
    function () {
      ...
      g.push(function n () {
        ...
        t[1] = [arguments],
        t[2] = [n]
        for (var o = 0; o < p.length && o < arguments.length; o++) { p[o] > 0 && (t[p[o]] = [arguments[o]]) }
        return r(f, e, c, l, t)
      })
    },
    function () {
